...
func install(dir ...string) error {
	...
	bus.Manager.Response(events.EventInstall, func(p *pluggable.Plugin, r *pluggable.EventResponse) {
		json.Unmarshal([]byte(r.Data), &r)
	})
	...
	_, err = bus.Manager.Publish(events.EventChallenge, cc.String())
	if err != nil {
		return err
	}
